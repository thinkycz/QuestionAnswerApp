 ...
 */
class ConnectController implements ContainerAwareInterface
{
     ...
     *
     *
     * @ Route(path="/connect", name="hwi_oauth_connect")
    ...
    public function connectAction(Request $request)
    {
        ...
        if ($error) {
            ...
            $this->container->get('thinky.appbundle.sweet_alert')->error('Nastala chyba', 'Přihlášení se nezdařilo, zkuste to prosím znova.');
        }
        else {
            $this->container->get('thinky.appbundle.sweet_alert')->success('Vítejte na palubě!', 'Byli jste úspěšně přihlášeni.');
        }
     ...
     * is enabled.
     *
     * @Route(path="/registration/{key}", name="hwi_oauth_connect_registration")
     ...
     *
     * @Route(path="/service/{service}", name="hwi_oauth_connect_service")
    ...
    /**
     * @Route(path="/redirect/{service}", name="hwi_oauth_service_redirect")
     * @param Request $request
